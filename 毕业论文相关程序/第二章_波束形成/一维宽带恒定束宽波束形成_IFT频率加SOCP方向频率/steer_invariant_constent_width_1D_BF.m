...
%         plot(ang_reference*ones(1,81),-80:0,'k');
...
%                 temp=find(ang>(beam_point+mainlobe_wide/2));
        ...
        xlabel('Azimuth Angle(Degrees)');
        ylabel('Beam Pattern Gain(dB)');
        title('Beam Pattern of Invariant Mainlobe Width');
...
%         legend('40度','60度')
        ...
        xlabel('Angles of Main Beam(Degrees)');
        ylabel('Azimuth Angle(Degrees)');
        zlabel('Beam Pattern(dB)');
        title('Steering Invariant Beam Pattern');
        ...
        figure(4);
        plot(ang_range,MainWidth,'ks-');
        xlabel('Azimuth Angle(Degrees)');
        ylabel('Mainlobe Width(dB)');
        title('Mainlobe Width Associated With Different Azimuth Angles');
        hold on;
%         axis([-65,65,20,40]);
